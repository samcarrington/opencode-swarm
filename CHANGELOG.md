...
## [6.23.0](https://github.com/samcarrington/opencode-swarm/compare/v6.22.20...v6.23.0) (2026-03-12)


### Features

* add Curator background analysis system with phase-level drift detection and knowledge injection ([8cf8d07](https://github.com/samcarrington/opencode-swarm/commit/8cf8d07ed8383948288fed53b31c6c0d0f8dfc91))
* add multi-language support with 11 language profiles (v6.16.0) ([bf33f8e](https://github.com/samcarrington/opencode-swarm/commit/bf33f8e2dc66dc9d55b598e1425f05748f25189a))
* add requirements-driven planning pipeline (v6.15.0) ([c2b6262](https://github.com/samcarrington/opencode-swarm/commit/c2b6262b62ebaa77b96fee13bae86b84f41576aa))
* add two-tier cross-project knowledge base (v6.17.0) ([6f0e90d](https://github.com/samcarrington/opencode-swarm/commit/6f0e90d8aea5590d1fc1f613b5a894667a931779))
* **gate-enforcement:** add per-task state machine, scope declaration, and hard blocks ([a1ab8ad](https://github.com/samcarrington/opencode-swarm/commit/a1ab8adb8378b3402c97184328e61442fd80774f))
* **gate-enforcement:** per-task state machine, scope declaration, and hard blocks (v6.21) ([90324cf](https://github.com/samcarrington/opencode-swarm/commit/90324cf53a88a7ad0132f9d8786b084d3e95e035))
* robustness, discoverability & intelligence expansion (v6.18.0) ([f5fd2ef](https://github.com/samcarrington/opencode-swarm/commit/f5fd2ef7667165101aeaa76fd8b2209193c79ad3))
* v6.19.0 — Prompt-Quality & Adversarial Robustness Update ([0fdf2e8](https://github.com/samcarrington/opencode-swarm/commit/0fdf2e818846a0f2c66b8ff42cd650b8d923f0c1))
* **v6.20:** add AST diffing, parallelism framework, PR gate, checkpoint extension, agent output, skill versioning, and context efficiency ([f13ea28](https://github.com/samcarrington/opencode-swarm/commit/f13ea285cb862dc0e5dae5e641b560bd5c0ffac5))
* **v6.20:** AST diffing, parallelism framework, PR gate, checkpoint extension, agent output, skill versioning ([d6acce7](https://github.com/samcarrington/opencode-swarm/commit/d6acce7dd3fe559e74fc0abde479f39e4678be8f))


### Bug Fixes

* add {{AGENT_PREFIX}} to remaining bare architect reference in FOR tag example ([6545fe0](https://github.com/samcarrington/opencode-swarm/commit/6545fe080cd302d5a189aff9439e68e71964863b))
* add bunx run subcommand for out-of-session plugin invocation (v6.17.2) ([847b0e4](https://github.com/samcarrington/opencode-swarm/commit/847b0e489f77370d64ea070739a5828732636a19))
* add handoff command, run memory service, and context budget guard ([efa334c](https://github.com/samcarrington/opencode-swarm/commit/efa334cd2e6435eda93176f3f3325a6e1d21d895))
* add handoff command, run memory, and context budget guard ([1118edb](https://github.com/samcarrington/opencode-swarm/commit/1118edbac57535eb83552251adb8eddffc264cca))
* add spec lifecycle fixes — explicit override, stale detection, archival, plan ingestion gate (v6.16.1) ([6c94b6c](https://github.com/samcarrington/opencode-swarm/commit/6c94b6c3e00826af59dab961cfe15c5bf72ca436))
* **architect:** tier QA gates to reduce low-risk churn ([5e38b05](https://github.com/samcarrington/opencode-swarm/commit/5e38b05a492c72b823abf17874a155c9d74618aa))
* **build:** remove misplaced src test artifact breaking declarations ([3bee31e](https://github.com/samcarrington/opencode-swarm/commit/3bee31ea841b6af5773478f2c514892666be10bb))
* centralize regex safety with escapeRegex/simpleGlobToRegex utilities ([2139031](https://github.com/samcarrington/opencode-swarm/commit/2139031404d2573d92b631408df5be66042d488b))
* centralize regex safety with escapeRegex/simpleGlobToRegex utilities ([efd034d](https://github.com/samcarrington/opencode-swarm/commit/efd034dd13eada386e15a3d259a37fa4269ec235))
* **ci:** remove native tree-sitter devDeps that compiled from source on Windows ([9138137](https://github.com/samcarrington/opencode-swarm/commit/9138137309f81ae2ac4c2287f7da436d4f5446a7))
* code review group A — JSON safety, regex escaping, directory threading ([590df9a](https://github.com/samcarrington/opencode-swarm/commit/590df9a4ca8bb0811ea0396691b4cb28a9598e57))
* correct broken anchor in docs/configuration.md ([40daacc](https://github.com/samcarrington/opencode-swarm/commit/40daaccd0a63ab81d876613e07a9c26f84af0b60))
* correct broken anchor in docs/configuration.md to #configuration-reference ([169b4c7](https://github.com/samcarrington/opencode-swarm/commit/169b4c756e50d1d794e44de92cdd7d4a7183bff3))
* diagnostic signal fidelity — warn→log reclassification and loadEvidence discriminated union (v6.17.3) ([986eed5](https://github.com/samcarrington/opencode-swarm/commit/986eed540328eb0803d70fdf9e7b61ebef22839a))
* **dist:** rebuild dist after lint fixes ([fb5be58](https://github.com/samcarrington/opencode-swarm/commit/fb5be5821387815798f99744a35cc0cfc168b4e8))
* **dist:** rebuild dist artifacts for cwd fixes and delegation-gate additions ([6ed7a5b](https://github.com/samcarrington/opencode-swarm/commit/6ed7a5b9169f0130997bac6cbcf90a48c4064cbd))
* **dist:** rebuild dist artifacts for update_task_status and write_retro tool additions ([03eb93a](https://github.com/samcarrington/opencode-swarm/commit/03eb93ac5bb5ef096bcb3a339cfb3351358abb27))
* expose update_task_status and write_retro tools, repair retro compatibility ([ec96421](https://github.com/samcarrington/opencode-swarm/commit/ec964215369bae5226e2c0cbb0abf46fce37e485))
* gate warn() behind DEBUG and block direct plan.md writes ([4763f25](https://github.com/samcarrington/opencode-swarm/commit/4763f25f29405930b2fe91ecfe7e6f44dc7f98f9))
* gate warn() behind DEBUG and block direct plan.md writes ([36897b1](https://github.com/samcarrington/opencode-swarm/commit/36897b1236994a2ac0013b299679ee787606114e))
* harden context enforcement and stabilize cross-platform CI ([7e4cf0a](https://github.com/samcarrington/opencode-swarm/commit/7e4cf0a513e5dc1cd13ff3f7645d25a1942a9e2c))
* harden JSON.parse, escape regex injection, thread directory into pipeline-tracker ([20b1163](https://github.com/samcarrington/opencode-swarm/commit/20b1163f1ca0925ef53aec65018545b7af9d2974))
* harden phase_complete agent aggregation and warnings ([cd5b202](https://github.com/samcarrington/opencode-swarm/commit/cd5b20257addf7019226764358810a6a10fdf73e))
* harden pre_check_batch, diff, glob, placeholder-scan, and sast-scan ([11c40f5](https://github.com/samcarrington/opencode-swarm/commit/11c40f5a1d4886a9c88c2403b563a74c6a5a8dda))
* honor qa_gates reviewer override in catastrophic phase checks ([17d2e79](https://github.com/samcarrington/opencode-swarm/commit/17d2e793dd9e62736d2b2d9c7697fa7eb6c79626))
* honor reviewer qa override in catastrophic checks ([c46b3da](https://github.com/samcarrington/opencode-swarm/commit/c46b3daa853049a6d2f0c3128e36e28c6fda0a6f))
* **hotfix-78:** summarization verification, gate-state wiring, and plan-state guard hardening ([1bc62e8](https://github.com/samcarrington/opencode-swarm/commit/1bc62e8993c2307e35bcd00dc836e531f044de63))
* **hotfix-78:** summarization verification, gate-state wiring, and plan-state guard hardening ([a42f4f1](https://github.com/samcarrington/opencode-swarm/commit/a42f4f1298b04518f1be8d7ca23825f201b518b7))
* implement issues [#145](https://github.com/samcarrington/opencode-swarm/issues/145) and [#146](https://github.com/samcarrington/opencode-swarm/issues/146) task/phase status handling ([e62749e](https://github.com/samcarrington/opencode-swarm/commit/e62749e8739faacbd66f935a83f609c4f6436649))
* **issue-124:** checkReviewerGate skips corrupt sessions; fix mock leakage in phase-monitor tests ([dc1da81](https://github.com/samcarrington/opencode-swarm/commit/dc1da8126aa4b3f53f528330404b48a3f728c68f))
* **lint:** remove CI-blocking biome errors in hooks ([3e8fe80](https://github.com/samcarrington/opencode-swarm/commit/3e8fe80bad25c2c4df6758c98798b7b4ac45ebe7))
* **lint:** replace control character regex literal with RegExp constructor to fix noControlCharactersInRegex CI error ([0673429](https://github.com/samcarrington/opencode-swarm/commit/0673429f3247dfee94f4e0a8c7194bc06264ced1))
* **lint:** resolve 5 biome errors introduced by Phase 1-4 hardening ([9dacdf3](https://github.com/samcarrington/opencode-swarm/commit/9dacdf360db80c4fb0e4bfd4e42d6dbde6ceb701))
* **lint:** resolve biome lint errors to unblock CI ([1aefafb](https://github.com/samcarrington/opencode-swarm/commit/1aefafb7ef46dbc84cd23c028fac6591a31c1fa0))
* move violation warnings to system messages and suppress repeated self-coding alerts ([e1d55b9](https://github.com/samcarrington/opencode-swarm/commit/e1d55b9303c7fd6e12b8f1d8ad46ef26aa51a50b))
* normalize bare agent name references in prompts to use {{AGENT_PREFIX}} ([efeb4bf](https://github.com/samcarrington/opencode-swarm/commit/efeb4bf099409151fa80ccadf1f319ceb8ce1eea))
* normalize prefixed agent names in isAgentDelegation to unblock QA gates for non-default swarms ([4ec0fc6](https://github.com/samcarrington/opencode-swarm/commit/4ec0fc6cd24cdca2ae32472ddec132e2b4c0263d))
* normalize subagent_type with stripKnownSwarmPrefix in isAgentDelegation to support prefixed agents like mega_reviewer/mega_test_engineer ([44eb706](https://github.com/samcarrington/opencode-swarm/commit/44eb706aa48107d86f3c2ec1d63a12d52d75ca9f))
* normalize task handoff and clarify architect setup ([c4c5cbb](https://github.com/samcarrington/opencode-swarm/commit/c4c5cbb8f127008823471055df9749cee9a202c3))
* normalize task tool name for architect handoff ([c832728](https://github.com/samcarrington/opencode-swarm/commit/c832728e533854d7da7e615692254e92913f4a6b))
* persist phaseAgentsDispatched across session restarts for phase_complete ([9b8d53e](https://github.com/samcarrington/opencode-swarm/commit/9b8d53ead540dacad19b2edccf6b41b4276f2926))
* persist phaseAgentsDispatched across session restarts for phase_complete ([bb1e068](https://github.com/samcarrington/opencode-swarm/commit/bb1e0688116fea45068f217da127c3ff8ed8e0d8))
* persist taskWorkflowStates in session snapshots and reconcile states from plan (Issue [#81](https://github.com/samcarrington/opencode-swarm/issues/81)) ([d5c3637](https://github.com/samcarrington/opencode-swarm/commit/d5c36376dee5d0db5bf19d6047f3bad346f086dd))
* phase completion reliability and workspace validation hardening ([4051d14](https://github.com/samcarrington/opencode-swarm/commit/4051d14b71d5f5cce5b8f479c534eac8817d436a))
* phase completion reliability and workspace validation hardening ([600e9bb](https://github.com/samcarrington/opencode-swarm/commit/600e9bb158e98f30e375ce784271f561492bcf98))
* phase_complete updates plan.json on success and adds completed-task fallback for agent requirements ([07c001d](https://github.com/samcarrington/opencode-swarm/commit/07c001d470152de7743ebd4bd8dc1d3f99af645b))
* phase_complete updates plan.json on success and adds completed-task fallback for agent requirements ([14888eb](https://github.com/samcarrington/opencode-swarm/commit/14888ebfc54d734e6f35ee114ae6b8efedc76401))
* plumb ToolContext.sessionID into phase_complete to fix cross-session tracking ([be22929](https://github.com/samcarrington/opencode-swarm/commit/be22929273309b22876e6d612263bb007ebce4d3))
* plumb ToolContext.sessionID into phase_complete to fix cross-session tracking ([e7f898e](https://github.com/samcarrington/opencode-swarm/commit/e7f898e1f43cbd83f20b9511a9afec88489dda26)), closes [#89](https://github.com/samcarrington/opencode-swarm/issues/89)
* read subagent_type from input.args in tool.execute.after hook ([87a0b1f](https://github.com/samcarrington/opencode-swarm/commit/87a0b1f406a2db367e5c04783534be812f11c62a))
* read subagent_type from input.args in tool.execute.after hook ([045c69d](https://github.com/samcarrington/opencode-swarm/commit/045c69d5ed2c7046963b25f2a1f28fd57f452803))
* **release:** realign release-please baseline to v6.19.0 ([02c505a](https://github.com/samcarrington/opencode-swarm/commit/02c505a0aa73aca0c9a96c288f04dc6d3cbdedf2))
* remove debug console.log, fix advanceTaskState guard, move batch warnings to system messages ([8f38933](https://github.com/samcarrington/opencode-swarm/commit/8f38933575b4ae809e9aa15477b55aa20df860cd))
* replace bare reviewer/test_engineer agent name references with {{AGENT_PREFIX}} in architect prompt ([e34fdab](https://github.com/samcarrington/opencode-swarm/commit/e34fdab4719289bb6e9731ea532de2394a707852))
* resolve .swarm output dir against project root in sbom_generate ([af49bd5](https://github.com/samcarrington/opencode-swarm/commit/af49bd5c4cbaeef8700c2aa5783fdad02409c86d))
* resolve .swarm output directory against project root in sbom-generate ([4e5a210](https://github.com/samcarrington/opencode-swarm/commit/4e5a210185577f46d65177f05de31f84069e75f4))
* resolve 26 test failures from knowledge system audit ([5bda121](https://github.com/samcarrington/opencode-swarm/commit/5bda12182a1210de2f4b9c8c796c728d50f7d9e6))
* resolve all 26 test failures in knowledge system audit ([ae49bc0](https://github.com/samcarrington/opencode-swarm/commit/ae49bc04f4bf219275c4801bfb92dccd07eaf962))
* resolve all biome lint errors to restore CI green ([2b19afc](https://github.com/samcarrington/opencode-swarm/commit/2b19afcbc1e8b1c8628a50ba6bd89a328b2150a5))
* resolve biome lint errors in regex utility and phase-complete ([bc2a2ac](https://github.com/samcarrington/opencode-swarm/commit/bc2a2acfb555e7bf16a0f8072a6cac71fde2295d))
* resolve path before isSourceCodePath check, fix test gate setup ([d16df29](https://github.com/samcarrington/opencode-swarm/commit/d16df2936a0cdc63713ada655c5189d92d368157))
* resolve path before isSourceCodePath check, fix test gate setup ([d498cc0](https://github.com/samcarrington/opencode-swarm/commit/d498cc0c171fb19796dadc8cea482824540829d5))
* resolve phase_complete fallback regressions affecting task status flow ([f908425](https://github.com/samcarrington/opencode-swarm/commit/f908425906e02c8d2fa8378fad8ec14e97a1091a))
* restore delegation-gate task advancement after task calls ([04c5212](https://github.com/samcarrington/opencode-swarm/commit/04c521267daf9fd2bcabcdc7d6a7017d3738d860))
* restore delegation-gate task advancement after task calls ([8894427](https://github.com/samcarrington/opencode-swarm/commit/8894427e230d742d3b895a70ead027c4b53d1348))
* restore release-please trigger after non-conventional merge ([00302b3](https://github.com/samcarrington/opencode-swarm/commit/00302b34deef33b536de547df726094e1fc9fc5d))
* restore release-please trigger with conventional commit guidance ([4caa55b](https://github.com/samcarrington/opencode-swarm/commit/4caa55b7ba489bf73d67e9996a1722582f4f1f06))
* retrospective schema mismatch — write_retro tool + /swarm write-retro command (v6.18.1) ([406a635](https://github.com/samcarrington/opencode-swarm/commit/406a6355648d5cfb1965d78fdc1f6c11370b01dd))
* seed task workflow state in new sessions during cross-session propagation ([1b49604](https://github.com/samcarrington/opencode-swarm/commit/1b496042b581634adc53a0bcbaf7b4e9e99a4cee))
* seed task workflow state in new sessions during cross-session propagation ([2c51514](https://github.com/samcarrington/opencode-swarm/commit/2c5151477866411e0dfb461b71d234a50d893f15))
* silent catch blocks in delegation-gate now log warnings; gate heuristic checks on coder delegation; fix [ ] sanitization ([b28dae1](https://github.com/samcarrington/opencode-swarm/commit/b28dae1e860a0f25b44181b0019aaae59b7169fe))
* state machine never advances on default config and CLI writes wrong config file ([#81](https://github.com/samcarrington/opencode-swarm/issues/81) [#84](https://github.com/samcarrington/opencode-swarm/issues/84)) ([ac8dffa](https://github.com/samcarrington/opencode-swarm/commit/ac8dffaaf6fb7c94675fa22621125cc420c20c57))
* state machine never advances on default config and CLI writes wrong config file ([#81](https://github.com/samcarrington/opencode-swarm/issues/81) [#84](https://github.com/samcarrington/opencode-swarm/issues/84)) ([9023b40](https://github.com/samcarrington/opencode-swarm/commit/9023b406527469672c644bb39610dae1e4fcd8e7))
* suppress repeated violation warnings and route all guardrail guidance to system messages ([9500d72](https://github.com/samcarrington/opencode-swarm/commit/9500d729353984d8732cb6f029216ec4fe626f38))
* test isolation - use DI for curator runner, loosen drift path traversal assertion ([e334e7d](https://github.com/samcarrington/opencode-swarm/commit/e334e7d461ad322b13d03765bf5c9531981b70c5))
* **tests:** always write explicit curator config in test helper to prevent user config leak ([d0543f4](https://github.com/samcarrington/opencode-swarm/commit/d0543f457488d59e42cdbd7dc6aa6562584603f2))
* **tests:** always write explicit curator config to prevent user config leak ([1e6a571](https://github.com/samcarrington/opencode-swarm/commit/1e6a571a009b3cd82d1ecb31a1c29b8024842e5b))
* **tests:** correct phase_complete adversarial test expectations for RETROSPECTIVE_MISSING behavior ([bc0383f](https://github.com/samcarrington/opencode-swarm/commit/bc0383ff14577e4f4fd18152d001c6c41c5500bf))
* **tests:** replace .resolves.not.toThrow() with Bun-compatible await pattern ([dd31ca5](https://github.com/samcarrington/opencode-swarm/commit/dd31ca5ee5b45489ef9ab0f09380a601d9dd737c))
* **tests:** replace .resolves.not.toThrow() with Bun-compatible await pattern ([d98173d](https://github.com/samcarrington/opencode-swarm/commit/d98173d99892f390b68e4cdae98bd7fbdac1cac7))
* tool hardening and Windows CI native-dep removal ([e6155e0](https://github.com/samcarrington/opencode-swarm/commit/e6155e09bed9705c1970c6b0d61b16ef6b24d804))
* **tools:** expose update_task_status and write_retro, repair retro compatibility, harden architect prompt ([694dd16](https://github.com/samcarrington/opencode-swarm/commit/694dd1656bd34dc5ffbfac71c0587bd898c6b9a0))
* use dynamic agent prefix in system-enhancer injected prompt text ([1873088](https://github.com/samcarrington/opencode-swarm/commit/187308862fc99897e8515e786e332e63baaf7d94))
* use workspace directory as cwd for all subprocess calls ([5e24335](https://github.com/samcarrington/opencode-swarm/commit/5e243354e3f7828c7537e9d69b4e65261025173e))
* use workspace directory as cwd for all subprocess calls ([3d855b6](https://github.com/samcarrington/opencode-swarm/commit/3d855b6f012c49543b86a40509cb749de63cbfcb))
* wire knowledge migrate command, retrieval outcomes, and dark matter persistence (v6.17.1) ([98ce920](https://github.com/samcarrington/opencode-swarm/commit/98ce920dee309ba61aa8f92bb8a5d5ed4a5fb1ec))
